...
def ml_loop():
    ...
    while True:
        ...
        vector[1] = ball_present[1] - ball_previous[0]#y分量
        prediction = [1,1]
        ...
        if not ball_served:
            ...
            if platform_x+10 < prediction[0] or platform_x-10 < prediction[0]:
                comm.send_instruction(scene_info.frame, PlatformAction.MOVE_RIGHT)
            elif platform_x+10 > prediction[0] or platform_x-10 < prediction[0]:
